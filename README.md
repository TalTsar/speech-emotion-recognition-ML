...
The EMODB database is the freely available German emotional database. The database contains a total of 535 utterances of 7 emotions: 1) anger; 2) boredom; 3) anxiety; 4) happiness; 5) sadness; 6) disgust; and 7) neutral. 
